                ...
                <>
                  {step.images.map((src, i) => (
                    <motion.div
                      ...
                      viewport={{ once: true, amount: 0.4 }}
                      variants={{
                        hidden: { scale: i > 0 ? 0.9 : 1, opacity: 0, rotate: 0 },
                        visible: {
                          scale: i > 0 ? 0.9 : 1,
                          opacity: 1,
                          rotate:
                            step.imagesRotation && step.imagesRotation[i] !== undefined
                              ? `${step.imagesRotation[i]}deg`
                              : i === 0
                              ? 0
                              : i === 1
                              ? "-30deg"
                      ...
                      transition={{ stiffness: 150, mass: 0.5, type: "spring", delay: i > 0 ? 0.8 : 0.5 }}
                      className={clsx(
                        "h-[30rem]",
                        i === 0 && "relative z-20 block",
                        i === 1 && "absolute origin-bottom-left hidden xl:block",
                        i === 2 && "absolute origin-bottom-right hidden xl:block"
                      )}
                    >
                      <IphoneFrame src={src} />
                    </motion.div>
